    ...
    <div className="bg-[#F5F1E8] text-[#2C2416]">
      ...
      <section className="py-20 px-8 md:px-16 bg-[#EAE4D7]">
        <div className="max-w-[1800px] mx-auto">
          ...
          <a
            href="/wedding-gallery"
            className="inline-block mt-8 px-8 py-3 border border-[#2C2416] hover:bg-[#2C2416] hover:text-[#F5F1E8] transition-all duration-300"
            style={{ fontFamily: "'Tenor Sans', sans-serif" }}
          >
            See More
          </a>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p
                className="text-lg leading-relaxed text-[#4A3F2E]"
                style={{ fontFamily: "'Tenor Sans', sans-serif" }}
              >
      ...
      <section
        ref={bookingRef}
        id="booking"
        className="py-32 px-8 md:px-16 bg-[#2C2416]"
      >
        <div className="max-w-[1200px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <h2
                className="text-5xl md:text-6xl lg:text-7xl mt-6 mb-8 leading-tight font-light text-[#F5F1E8]"
                style={{ fontFamily: "'Cormorant', serif" }}
              >
                Let&apos;s Create
                <br />
              ...
              <div className="w-16 h-[1px] bg-[#8B7355] mb-8" />
              <p
                className="text-[#F5F1E8]/70 leading-relaxed text-lg mb-10"
                style={{ fontFamily: "'Tenor Sans', sans-serif" }}
              >
                Every great story deserves to be told beautifully. Reach out and
                lets begin crafting yours — from intimate portraits to grand
                wedding celebrations.
              </p>
              <div
                className="space-y-4 text-[#F5F1E8]/60 text-sm tracking-wider mb-10"
                style={{ fontFamily: "'Tenor Sans', sans-serif" }}
              >
              ...
              {formStatus === "sent" ? (
                <div className="flex flex-col items-center justify-center h-full py-20 text-center">
                  ...
                  <button
                    ...
                    className="mt-8 text-xs tracking-[0.2em] text-[#8B7355] underline underline-offset-4"
                  >
                ...
                >
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <label className="text-[#F5F1E8]/40 text-xs tracking-[0.2em] block mb-2">
                        FULL NAME *
                      </label>
                      <input
                        type="text"
